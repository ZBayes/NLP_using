...
# 数据加载
pos = data_loader("../../../data/shopping_review/pos.xls", file_type = 'excel', import_type = 'pd') 
neg =data_loader("../../../data/shopping_review/neg.xls", file_type = 'excel', import_type = 'pd') 
